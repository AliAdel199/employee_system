...
void _userModelSerialize(
  ...
  writer.writeString(offsets[5], object.passwordSalt);
...
UserModel _userModelDeserialize(
  ...
  object.passwordSalt = reader.readString(offsets[5]);
  object.role =
      _UserModelroleValueEnumMap[reader.readStringOrNull(offsets[6])] ??
          UserRole.admin;
...
extension UserModelQueryWhereSort
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhere> anyUsername() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhere> anyIsActive() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension UserModelQueryWhere
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> usernameGreaterThan(
    String username, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> usernameLessThan(
    String username, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> usernameBetween(
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> usernameStartsWith(
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> usernameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'username',
        value: [''],
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> usernameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> isActiveEqualTo(
      bool isActive) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> isActiveNotEqualTo(
      bool isActive) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension UserModelQueryFilter
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> passwordSaltEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> passwordSaltBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> passwordSaltMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension UserModelQuerySortBy on QueryBuilder<UserModel, UserModel, QSortBy> {
  ...
  QueryBuilder<UserModel, UserModel, QAfterSortBy> sortByPasswordSalt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'passwordSalt', Sort.asc);
    });
  }

  QueryBuilder<UserModel, UserModel, QAfterSortBy> sortByPasswordSaltDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserModelQuerySortThenBy
  ...
  QueryBuilder<UserModel, UserModel, QAfterSortBy> thenByPasswordSalt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'passwordSalt', Sort.asc);
    });
  }

  QueryBuilder<UserModel, UserModel, QAfterSortBy> thenByPasswordSaltDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'passwordSalt', Sort.desc);
    });
  }
...
extension UserModelQueryWhereDistinct
  ...
  QueryBuilder<UserModel, UserModel, QDistinct> distinctByPasswordSalt(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
